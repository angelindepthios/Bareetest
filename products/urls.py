...
from .views import (
    product_detail, product_list, get_product_list_json, get_product_detail_json, 
    delete_review, toggle_wishlist, wishlist_list, submit_review, get_reviews
)

urlpatterns = [
    path("products/", product_list, name="product_list"),
    path("product/<uuid:pk>/", product_detail, name="product_detail"),
    path('reviews/<uuid:pk>/submit/', submit_review, name="submit_review"),
    ...
    path("get-reviews/<uuid:pk>/", get_reviews, name="get_reviews"),
]
